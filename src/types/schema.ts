...
export class User extends Entity {
  ...
  get pairDayData(): Array<string> | null {
  ...
  set pairDayData(value: Array<string> | null) {
    if (!value) {
      this.unset("pairDayData");
    } else {
      this.set("pairDayData", Value.fromStringArray(<Array<string>>value));
    }
  }
...
export class UserPairDayData extends Entity {
  constructor(id: string) {
    super();
    this.set("id", Value.fromString(id));
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save UserPairDayData entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.STRING,
        "Cannot save UserPairDayData entity with non-string ID. " +
          'Considering using .toHex() to convert the "id" to a string.'
      );
      store.set("UserPairDayData", id.toString(), this);
    }
  }

  static load(id: string): UserPairDayData | null {
    return changetype<UserPairDayData | null>(store.get("UserPairDayData", id));
  }
